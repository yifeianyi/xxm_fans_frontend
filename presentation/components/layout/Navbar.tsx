...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full glass-card border-b border-white/50 px-4 py-2.5 flex items-center justify-center gap-3 md:gap-6">
            ...
            <ReactRouterDOM.Link to="/data" className={`relative py-1 flex flex-col items-center transition-all ${isData ? 'text-[#f8b195] scale-105' : 'text-[#8eb69b]'}`}>
                <span className="text-xs md:text-sm font-black whitespace-nowrap px-2">满の数据</span>
