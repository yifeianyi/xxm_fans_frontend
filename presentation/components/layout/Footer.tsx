...
const Footer: React.FC = () => {
  ...
  const footerLinks = [
    ...
    { name: '原唱作品', to: '/songs/originals', icon: Music },
  ...
  const externalLinks = [
    { name: '咻咻满B站空间', href: 'https://space.bilibili.com/444035653' },
    { name: '咻咻满直播间', href: 'https://live.bilibili.com/21533584' },
    { name: '满满来信投稿', href: 'https://www.bilibili.com/read/cv19520066' },
  ];
    ...
    <footer className="mt-auto border-t border-white/40 bg-white/10 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <p className="text-sm text-[#6b9b7a] leading-relaxed">
              小满虫之家是咻咻满官方粉丝站，致力于收录咻咻满（XXM）的所有音乐作品、
              演出记录和粉丝二创。
            </p>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <p className="text-center text-[10px] text-[#a5c9b1] mt-4 max-w-2xl mx-auto leading-relaxed">
          春风拂过青草地，满满歌声暖人心。本站为咻咻满粉丝自建非官方网站，
