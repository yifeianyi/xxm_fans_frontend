...
import { Sparkles, Star, Heart, Music, Crown } from 'lucide-react';
import { PageDecorations } from '@/app/presentation/components/common/PageDecorations';
import OriginalsList from '@/app/presentation/components/songs/OriginalsList';

export const metadata: Metadata = {
    title: '咻咻满原唱作品 - 个人原创单曲 | 小满虫之家',
    description: '浏览咻咻满的原创音乐作品，感受独特的音乐风格和创作理念。每首原创作品都记录着满老师的音乐心路历程。',
    keywords: ['咻咻满', '原唱', '原创音乐', '单曲', 'XXM'],
};
