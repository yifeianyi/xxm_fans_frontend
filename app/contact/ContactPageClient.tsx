...
import { Mail, Globe, Heart, Music, MessageCircle, Send, Sparkles, Star, Flower2 } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <div className="flex items-center justify-center mb-4">
                        ...
                        <div className="w-2 h-2 rounded-full bg-[#f8b195] mx-2"></div>
                    ...
                    <div className="mb-10">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                ...
                                <p className="text-[#52566e] leading-relaxed">
                                    本站为<strong className="text-[#c45a42]">粉丝自建网站</strong>，所有内容仅供粉丝交流学习使用。
                                </p>
                            </div>
